...
echo ------------------------------------------------------------------------
echo Downloader missing, using fallback: %WRAPPER_JAR%
echo ------------------------------------------------------------------------
powershell -Command "&{"^
"$webclient = new-object System.Net.WebClient;"^
"if (-not ([System.String]::IsNullOrEmpty('%MVNW_USERNAME%') -and [System.String]::IsNullOrEmpty('%MVNW_PASSWORD%'))) {"^
...
@REM Provide a "standard" way to retrieve the CLI args that will
